...
Latest API and SDK updates, newest first. [Discuss updates on Discord](https://discord.gg/hTYatWYWBc).

<Update label="September 1, 2026" tags={["providers-api", "accounts-api", "agentid", "new-feature", "docs"]}>
